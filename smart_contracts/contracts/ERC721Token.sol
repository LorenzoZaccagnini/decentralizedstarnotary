...
contract ERC721Token is ERC721 {
    ...
    function safeTransferFrom(address _from, address _to, uint256 _tokenId, bytes data) public payable { 
        ...
        require(_checkAndCallSafeTransfer(_from, _to, _tokenId, data));
    }
    ...
    /// @param _to The new owner
    /// @param _tokenId The NFT to transfer
    function transferFrom(address _from, address _to, uint256 _tokenId) public payable hasPermission(msg.sender, _tokenId) { 
        transferFromHelper(_from, _to, _tokenId);
    }
